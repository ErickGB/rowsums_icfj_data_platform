...
-----------------------------------------------------------------------------
--delete from staging.employee_salary;
--drop table salaries.f_employee_salary;
--drop table salaries.d_people;
--drop table salaries.d_entity;
...
CREATE UNIQUE INDEX person_id_IDX ON salaries.d_people (person_id);
...
UPDATE salaries.d_people p
 ...
 select * from salaries.d_people limit 100;
 select record_date, count(*) from staging.employee_salary group by record_date;
...
DELETE FROM salaries.f_employee_salary;
DELETE FROM salaries.d_entity;
DELETE FROM salaries.d_people;
