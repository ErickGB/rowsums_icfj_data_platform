...
url_dinamic <- "http://ogov.defensoria.gob.pa/transparencia/index.php?option=com_grid&amp;gid=22_fg_1&amp;o_b=id&amp;o_d=ASC&amp;p=x_url&amp;rpp=125&id=22"
entity_name <- "Autoridad de Protección al Consumidor"
code_id <- "904"
output_file_name <- "aut_consumidor_gov_salaries_"
...
file_name <- paste0("./00_data/images/",update_year, "/",  update_month, "/consumidor_last_update_", paste0(update_month, update_year)  ,"_process_", execution_date,".png")
file_name
