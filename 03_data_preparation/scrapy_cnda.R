...
url <- paste0("http://190.34.178.196/aduana/SIGA_SICE/index.php?calendario_desde=", date_start,"&calendario_hasta=", date_end,"&ruc=&importador=&tipo_oper=I&puerto=&arancel=&mercancia=&cantresxpag=50000&pag=formprin&Accion_Consultar=Consultar")
...
# table for get data
count <- ceiling(as.numeric(record_text) / 50000) - 1
