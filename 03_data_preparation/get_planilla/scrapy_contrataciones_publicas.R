...
url <- "http://ogov.defensoria.gob.pa/transparencia/index.php?option=com_k2&view=item&layout=item&id=56"
url_dinamic <- url #"http://ogov.defensoria.gob.pa/transparencia/index.php?option=com_grid&amp;gid=16_bq_1&amp;o_b=id&amp;o_d=ASC&amp;p=x_url&amp;rpp=125&id=56"
entity_name <- "Dirección General de Contrataciones Públicas"
code_id <- "906"
output_file_name <- "dir_contrataciones_publicas_gov_salaries_"
image_file_name <- "dir_contrataciones_publicas_last_update_"
